...
public class UsingMap{
	public static void main(String[] args){
		...
		boolean hasKey = map.containsKey(106);
		System.out.println("Contains '106': " + hasKey);
